            ...
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        <img src="<?php echo $this->Url->build('/img/logo.png');?>" alt="Nifty Logo" class="brand-icon">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="row img-gallery">
                                            <div class="col-xs-4">
                                                <?php echo $this->Html->image('thumbs/img-1.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                            <div class="col-xs-4">
                                            <?php echo $this->Html->image('thumbs/img-3.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                            <div class="col-xs-4">
                                            <?php echo $this->Html->image('thumbs/img-2.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                            <div class="col-xs-4">
                                            <?php echo $this->Html->image('thumbs/img-4.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                            <div class="col-xs-4">
                                            <?php echo $this->Html->image('thumbs/img-6.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                            <div class="col-xs-4">
                                            <?php echo $this->Html->image('thumbs/img-5.jpg', ['alt' => 'thumbs', 'class' => 'img-responsive']); ?>
                                            </div>
                                        </div>
                    ...
                    <ul class="nav navbar-top-links">
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <?php echo $this->Html->image('profile-photos/9.png', ['alt' => 'Profile Picture', 'class' => 'img-circle img-sm']); ?>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                    	<?php echo $this->Html->image('profile-photos/3.png', ['alt' => 'Profile Picture', 'class' => 'img-circle img-sm']); ?>
                                                    </div>
                                                    <div class="media-body">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    <li>
                                        <a href="#"><i class="demo-pli-male icon-lg icon-fw"></i> Meu Perfil</a>
                                    </li>
                                    <li>
                                        <a href="#"><span class="badge badge-danger pull-right">9</span><i class="demo-pli-mail icon-lg icon-fw"></i> Mensagens</a>
                                    </li>
                                    <li>
                                        <a href="#"><span class="label label-success pull-right">New</span><i class="demo-pli-gear icon-lg icon-fw"></i> Configurações</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="demo-pli-computer-secure icon-lg icon-fw"></i> Bloquear Tela</a>
                                    </li>
                                    <li>
                                        <a href="pages-login.html"><i class="demo-pli-unlock icon-lg icon-fw"></i> Sair</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
